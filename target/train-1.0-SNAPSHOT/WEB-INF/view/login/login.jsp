...
<div class="header" style="padding: 0;">
    <h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生教务系统</h2>
</div>
<div id="login_frame">
    ...
    <form method="post" action="login.js">
        ...
        <div id="login_control">
            ...
            <input type="button" id="btn_login2" value="学生注册" onclick="studentReg()" class="text_field"/>
        </div>
