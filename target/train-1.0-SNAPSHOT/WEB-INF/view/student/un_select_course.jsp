...
<div class="header" style="padding: 0;">
    <h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">未选课程列表</h2>
</div>
...
<table>
    ...
    <tr>
        ...
        <td><button onclick="selectCourse(<%=courseResult.getId() %>)" >选课</button></td>
    </tr>
    <%}
    %>
</table>
