...
<div class="header" style="padding: 0;">
    <h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">任教课程列表</h2>
</div>
...
<table>
    ...
    <tr>
        ...
        <td><a href="/api/auth/teacher/course/score/<%=courseResult.getId() %>" id="s_link">录入成绩</a></td>
    </tr>
    <%}
    %>
</table>
